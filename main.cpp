...
for (i=0; i<NUMDEPENDENCIAS; i++){
		if (dependencia[i][0]==num) rotarObjeto(dependencia[i][1],k,x0,y0,z0);
	}
...
if (KEY=='x') SCALE1-=0.2;
if (KEY=='m') SCALE2-=0.2;
if (SCALE1<0.4) SCALE1=1.4;
if (SCALE2<0.4) SCALE2=1.4;

if (KEY=='z') COLOR1-=0.2;
if (KEY=='n') COLOR2-=0.2;
if (COLOR1<0.4) COLOR1=1.0;
if (COLOR2<0.4) COLOR2=1.0;

if (KEY=='p') VIEWMODE*=-1;
if (KEY=='t') TYPE*=-1;

if (KEY==9) SELECTED++;
if (SELECTED>=NUMSEGMENTOS) SELECTED=0;
